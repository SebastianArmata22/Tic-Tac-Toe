...
function checkWin(){
if(array_signs[0]==array_signs[1]==array_signs[2]!=""
    ||array_signs[3]==array_signs[4]==array_signs[5]!=""
    ||array_signs[6]==array_signs[7]==array_signs[8]!=""
    ||array_signs[0]==array_signs[3]==array_signs[6]!=""
    ||array_signs[1]==array_signs[4]==array_signs[7]!=""
    ||array_signs[2]==array_signs[5]==array_signs[8]!=""
    ||array_signs[0]==array_signs[4]==array_signs[8]!=""
    ||array_signs[2]==array_signs[4]==array_signs[6]!="")
    {
